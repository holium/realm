...
export default class RemoteTrackPublication extends TrackPublication {
  ...
  private isManualOperationAllowed(): boolean {
    ...
    //   console.warn('adaptive stream is enabled, cannot change track settings', {
    //     trackSid: this.trackSid,
    //   });
    //   return false;
    // }
    if (!this.isSubscribed) {
      console.warn('cannot update track settings when not subscribed', {
        trackSid: this.trackSid,
      });
      return false;
    }
  ...
  //   return (
  //     this.track instanceof RemoteVideoTrack && this.track.isAdaptiveStream
  //   );
  // }
