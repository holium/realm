...
export default function createDetectElementResize(hostWindow: Window) {
  ...
  if (!attachEvent) {
    ...
    var checkTriggers = function (element: any) {
      return (
  ...
  var createStyles = function (doc: any) {
  ...
  var addResizeListener = function (element: any, fn: any) {
    if (attachEvent) {
  ...
  var removeResizeListener = function (element: any, fn: any) {
    if (attachEvent) {
