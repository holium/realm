...
export type CellCache = Record<string, React.ReactElement<any>>;
export type StyleCache = Record<string, Record<string, any>>;
export type CellRangeRendererParams = {
  ...
  visibleColumnIndices: Record<string, any>;
  visibleRowIndices: Record<string, any>;
};
