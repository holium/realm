...
class Grid extends React.PureComponent<Props, State> {
  ...
  _scrollingContainer: Element | undefined;
  _childrenToDisplay: React.ReactElement<any>[] | undefined;
  _columnStartIndex: number | undefined;
  _columnStopIndex: number | undefined;
  _rowStartIndex: number | undefined;
  _rowStopIndex: number | undefined;
  _renderedColumnStartIndex: number | undefined = 0;
  _renderedColumnStopIndex: number | undefined = 0;
  _renderedRowStartIndex: number | undefined = 0;
  _renderedRowStopIndex: number | undefined = 0;
  _initialScrollTop: number | undefined;
  _initialScrollLeft: number | undefined;
  _disablePointerEventsTimeoutId: AnimationTimeoutId | null | undefined;
  ...
  constructor(props: Props) {
    ...
    const columnSizeAndPositionManager = new ScalingCellSizeAndPositionManager({
      ...
      cellSizeGetter: (params) =>
        Grid._wrapSizeGetter(props.columnWidth)(params),
  ...
  scrollToCell({ columnIndex, rowIndex }: CellPosition) {
    ...
    if (rowIndex !== undefined) {
      this._updateScrollTopForScrollToRow({ ...props, scrollToRow: rowIndex });
    }
  }
  ...
  static getDerivedStateFromProps(
    ...
    let maybeStateA: Partial<State> = {};
    let maybeStateB: Partial<State> = {};
  ...
  render() {
    ...
    return (
      <div
        ...
        tabIndex={tabIndex}
      >
        {childrenToDisplay && childrenToDisplay.length > 0 && (
          <div
            role={containerRole}
            style={{
  ...
  _calculateChildrenToRender(
    ...
    const scrollTop =
      this._initialScrollTop && this._initialScrollTop > 0
        ? this._initialScrollTop
        : state.scrollTop;
    const scrollLeft =
      this._initialScrollLeft && this._initialScrollLeft > 0
  ...
  static _getCalculatedScrollTop(nextProps: Props, prevState: State) {
    const { height, rowCount, scrollToAlignment, scrollToRow, width } =
      nextProps;
  ...
  _resetStyleCache() {
    ...
    for (
      ...
      for (
        let columnIndex: number = this._columnStartIndex;
  ...
  _onScroll: UIEventHandler<HTMLDivElement> = (event) => {
