...
const SecondaryButtonText = styled.button<FontSizeProps & FontWeightProps & MarginProps>`
  ${fontSize}
  ${fontWeight}
  ${margin}
  ...
  (props: BaseDialogProps) => {
    ...
    return (
      <Grid.Column noGutter lg={12} xl={12} px={32}>
        ...
        <Grid.Row >
          <Flex width="100%" height="100%" alignItems="center" justifyContent="center">
            <Flex flexDirection="column" alignItems="top" justifyContent="space-between">
              <Button
                variant="minimal"
                alignSelf="center"
                fontWeight={500}
              ...
              <SecondaryButtonText mt={20} fontSize={2} fontWeight={400} onClick={selectSelfHosted}>
                Already have one?
              </SecondaryButtonText>
            </Flex>
          </Flex>
