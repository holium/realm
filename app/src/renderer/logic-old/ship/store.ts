...
import { ShipModel as BaseShipModel } from '../../../core-a/ship/stores/ship';
...
export const ShipStore = types
  ...
  .actions((self) => ({
    ...
    initialSync: (syncEffect: {
      ...
      servicesStore.SpacesService.setShipSpace(self.ship!);

      // TODO clean up authstore
      servicesStore.AuthService.authStore.loader.set('loaded');
