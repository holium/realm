...
declare type Socket = import('net').Socket;
declare module 'node-ipc' {
  ...
  interface Server extends Client {
    ...
    emit(value: any): void;
    emit(event: string, value: any): void;
    emit(socket: Socket | SocketConfig, event: string, value?: any): void;
    emit(socketConfig: Socket | SocketConfig, value?: any): void;
  }
